...
const badgeVariants = cva(
  "inline-flex items-center gap-1 rounded-full border px-3 py-1 text-metadata font-semibold transition-smooth focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
